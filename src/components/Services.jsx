...
export const services = [
...

  {
    ...
    seoHeading: 'Professional SEO Audit Services — Find & Fix What\'s Costing You Rankings',
    description:
      'Find out exactly why your website isn\'t ranking. Stryvenix runs a full technical, on-page, and content SEO audit — then hands you a prioritized action plan to fix it.',
    longDescription:
      'Our SEO audit covers technical health (crawlability, indexing, Core Web Vitals, site speed), on-page factors (title tags, headings, internal linking, schema markup), and content gaps versus your competitors. You get a clear, prioritized report — not a 60-page PDF nobody reads — so you know exactly what to fix first for the biggest ranking impact.',
    features: [
      'Technical SEO health check',
      'On-page & content audit',
      'Core Web Vitals & site speed review',
    ...
    icon: 'search',
    slug: 'seo-audit',
    keywords: ['SEO audit', 'website SEO audit', 'technical SEO audit', 'SEO audit services', 'Stryvenix SEO'],
  },
...

  {
    ...
    seoHeading: 'Website Maintenance & Support Plans for Growing Businesses',
    description:
      'Keep your website fast, secure, and up to date — without lifting a finger. Stryvenix\'s maintenance plans cover updates, backups, monitoring, and small content changes so your site never falls behind.',
    longDescription:
      'Every website we ship includes 6 months of support, and our ongoing maintenance plans extend that indefinitely. We handle software and dependency updates, uptime and security monitoring, regular backups, performance checks, and small content or design tweaks — so you can focus on running your business while we keep the website running smoothly.',
    features: [
      'Uptime & security monitoring',
      'Regular backups',
      'Software & dependency updates',
      'Performance health checks',
      'Minor content & design edits',
    ...
    keywords: ['website maintenance', 'website support plan', 'website care plan', 'Stryvenix maintenance'],
  },
