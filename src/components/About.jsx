...
//     target: timelineRef,
//     offset: ["start 75%", "end 50%"] // Starts drawing when top hits 75% of viewport, finishes when bottom hits center
//   });
...
//                     {/* Scroll-Triggered Glowing Dot */}
//                     <motion.div
//                       initial={{ scale: 0, opacity: 0, backgroundColor: '#94a3b8' }}
//                       whileInView={{ scale: 1, opacity: 1, backgroundColor: '#6366f1' }}
//                       viewport={{ once: true, margin: "-15%" }}
//                       transition={{ type: "spring", stiffness: 300, damping: 20 }}
//                       className="hidden sm:flex w-4 h-4 rounded-full ring-4 ring-white dark:ring-slate-900 group-hover:ring-indigo-100 dark:group-hover:ring-indigo-500/20 relative z-10 flex-shrink-0 items-center justify-center transition-all duration-300"
//                       aria-hidden="true"
//                     >
//                        {/* Inner active dot */}
//                        <div className="w-1.5 h-1.5 bg-white rounded-full shadow-sm" />
//                        {/* Outer Glow on hover */}
//                        <div className="absolute inset-0 rounded-full bg-indigo-400 opacity-0 group-hover:opacity-40 blur-sm transition-opacity duration-300" />
//                     </motion.div>
//                   </div>
